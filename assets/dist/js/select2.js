...
(function (root, factory) {
   ...
   (function ($) {
      ...
      Selectpicker.prototype = {
               ...
               if (isOptgroup && $this.data("divider") !== true) {
                  if (that.options.hideDisabled && isDisabled) {
                     if ($parent.data("allOptionsDisabled") === undefined) {
                        ...
                        $parent.data(
                           "allOptionsDisabled",
                           $options.filter(":disabled").length ===
                              $options.length
                        );
                     }
                  ...
                  if ($this.index() === 0) {
                     ...
                     if (index !== 0 && _li.length > 0) {
                        ...
                        liIndex++;
                        _li.push(
                           generateDiv("", "dropdown-divider", optID + "div")
                        );
                     }
                     liIndex++;
                     _li.push(
                  ...
                  _li.push(
                     generateA(
                        generateSpan(text, optionClass, inline, tokens),
                        index,
                        "hidden is-hidden"
                     )
                  );
         ...
         findLis: function () {
            if (this.$lis == null)
               this.$lis = this.$menu.find(
                  "a, .dropdown-header, .dropdown-divider"
               );
            return this.$lis;
         },
         ...
         liHeight: function (refresh) {
            ...
            newElement.className =
               this.$menu[0].parentNode.className + " show open"; // bootstrap 4 requires show instead of open
            ...
            if (this.options.size === "auto") {
               var getSize = function () {
                  ...
                  $menuInner.css({
                     ...
                     "overflow-y": "auto",
                     "min-height":
                        Math.max(minHeight - menuPadding.vert, 0) + "px"
                  });
               };
               getSize();
               this.$searchbox
               ...
               var optIndex = this.$lis
                  ...
                  divLength = this.$lis
                     .slice(0, optIndex + 1)
                     .filter(".dropdown-divider").length;
               menuHeight =
         ...
         setDisabled: function (index, disabled, $lis) {
            ...
            if (disabled) {
               $lis
                  .addClass("disabled")
                  .children("span.dropdown-item-inner")
                  .attr("href", "#")
                  .attr("tabindex", -1)
         ...
         clickListener: function () {
                     ...
                     if (maxOptions !== false || maxOptionsGrp !== false) {
                        ...
                        if (
                           ...
                           if (maxOptions && maxOptions == 1) {
                              ...
                              var maxOptionsText =
                                    typeof that.options.maxOptionsText ===
                                    "string"
                                       ? [
            ...
            this.$menu.on(
               "click",
               "a.disabled span.dropdown-item-inner , .popover-title, .popover-title :not(.close)",
               function (e) {
            ...
            this.$searchbox.on("input propertychange", function () {
               ...
               if (that.$searchbox.val()) {
                  var $searchBase = that.$lis.not(
                        ".is-hidden, .dropdown-divider, .dropdown-header"
                     ),
                     $hideItems;
         ...
         changeAll: function (status) {
            ...
            var $options = this.$element.find("option"),
               $lisVisible = this.$lis.not(
                  ".dropdown-divider, .dropdown-header, .disabled, .d-none"
               ),
            ...
            if (status) {
               if (
                  $lisVisible.filter(".selected").length === $lisVisible.length
               )
                  return;
            } else {
         ...
         keydown: function (e) {
            var $this = $(this),
               ...
               isActive,
               selector =
                  ":not(.disabled, .d-none, .dropdown-header, .dropdown-divider)",
               keyCodeMap = {
                  32: " ",
                  48: "0",
                  49: "1",
            ...
            isActive =
               that.$newElement.hasClass("open") ||
               that.$newElement.hasClass("show");
            ...
            if (/(38|40)/.test(e.keyCode.toString(10))) {
               ...
               if (e.keyCode == 38) {
                  if (
                     (that.options.liveSearch || index == prevIndex) &&
                     index != -1
                  )
                     index--;
               ...
               prevKey = $.trim($(":focus").text().toLowerCase()).substring(
                  0,
                  1
               );
